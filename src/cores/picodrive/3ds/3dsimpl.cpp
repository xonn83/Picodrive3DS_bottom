...
void impl3dsEmulationBegin()
{
	...
	gpu3dsSetRenderTargetToBottomFrameBuffer();
	gpu3dsFlush();	
	//if (emulator.isReal3DS)
...
void impl3dsRenderDrawTextureToFrameBuffer()
{
	...
	switch (settings3DS.ScreenStretch)
	{
		case 0:
			...
			gpu3dsAddQuadVertexes(bx, 0, 320 - bx, 240, tx1, 0, tx2, 240, 0);
			break;
		case 7:
            ...
            gpu3dsSetTextureEnvironmentReplaceTexture0();
            gpu3dsBindTextureMainScreen(video3dsGetPreviousScreenTexture(), GPU_TEXUNIT0);
			gpu3dsAddQuadVertexes(0, 0, 320, 240, tx1, 0, tx2, 240, 0);
			break;
		case 1:
            ...
            gpu3dsSetTextureEnvironmentReplaceTexture0();
            gpu3dsBindTextureMainScreen(video3dsGetPreviousScreenTexture(), GPU_TEXUNIT0);
			gpu3dsAddQuadVertexes(0, 0, 320, 240, tx1, ty1, tx2, ty2, 0);
			break;
		case 5:
            // 5:4 PAL Fit (300x240)
            gpu3dsSetTextureEnvironmentReplaceColor();
            ...
            gpu3dsSetTextureEnvironmentReplaceTexture0();
            gpu3dsBindTextureMainScreen(video3dsGetPreviousScreenTexture(), GPU_TEXUNIT0);
			gpu3dsAddQuadVertexes(10, 0, 310, 240, tx1, ty1, tx2, ty2, 0);
			break;
		case 2:
            // Full Screen (400x240)
            gpu3dsSetTextureEnvironmentReplaceTexture0();
		...
		case 3:
            ...
            gpu3dsSetTextureEnvironmentReplaceTexture0();
            gpu3dsBindTextureMainScreen(video3dsGetPreviousScreenTexture(), GPU_TEXUNIT0);
			gpu3dsAddQuadVertexes(0, 0, 320, 240, tx1 + 8, ty1 + 8, tx2 - 8, ty2 - 8, 0);
			break;
		case 6:
            ...
            gpu3dsSetTextureEnvironmentReplaceTexture0();
            gpu3dsBindTextureMainScreen(video3dsGetPreviousScreenTexture(), GPU_TEXUNIT0);
			gpu3dsAddQuadVertexes(10, 0, 310, 240, tx1 + 8, ty1 + 8, tx2 - 8, ty2 - 8, 0);
			break;
		case 4:
